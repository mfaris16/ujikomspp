		...
		<div class="flash-data" data-flashdata="<?= $this->session->userdata('flash') ?>"></div>
		<h5>Data Siswa</h5>
		<div class="card mt-3">
			<div class="container">
				<div class="row">
		...
		<div class="row">
						...
						<?php
							...
							<form method="post" action="<?php echo site_url('Pembayaran/Proses_Bayar_SPP') ?>">
		 						<div class="row" style="margin: 3px 0 3px 0;padding-top: 10px;border-radius: 2px;border: 1px solid rgba(2,2,2,.1);color: #333;">
		 							...
		 							<div class="col">
		 								<button class="btn btn-sm btn-success tombol-bayar">Bayar</button>
		 							</div>
		 						</div>
		 					</form>
			...
			<?php 
					...
					<?php foreach($no as $no_TN3){
							$hitungTN2 = count((array)$TN3[$no_TN3]);
							if($hitungTN2 > 0){ ?>
								<div class="row" style="margin: 3px 0 3px 0;padding-top: 10px;border-radius: 2px;border: 1px solid rgba(2,2,2,.1);color: #333;background: rgba(200,200,200,.1);">
									<div class="col-md-4">
							...
							<form method="post" action="<?php echo site_url('Pembayaran/Proses_Bayar_SPP') ?>">
		 						<div class="row" style="margin: 3px 0 3px 0;padding-top: 10px;border-radius: 2px;border: 1px solid rgba(2,2,2,.1);color: #333;">
		 							...
		 							<div class="col">
		 								<?php if($numrows_2 < 12){ ?>
		 								<?php }else{ ?>
		 									<button class="btn btn-sm btn-success tombol-bayar" onclick="Swal.fire('Hello World','Latihan Sweet Alert', 'success')">Bayar</button>
		 								<?php } ?>
		 							</div>
		 						</div>
		 					</form>
